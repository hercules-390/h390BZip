...
get_filename_component( compr_file            ${TEST_CASE}.rb2 REALPATH )
get_filename_component( decmp_file            ${TEST_CASE}.tst REALPATH )
...
# Remove the created workfiles from the build directory.

file( REMOVE ${compr_file} ${decmp_file} )
